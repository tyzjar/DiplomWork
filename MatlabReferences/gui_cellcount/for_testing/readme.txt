gui_cellcount MATLAB .NET Assembly (.NET Component)
...
gui_cellcount_overview.html - HTML overview documentation file for the generated 
                              component. It contains the requirements for accessing the 
                              component and for generating arguments using the MWArray 
                              class hierarchy.

gui_cellcount.xml - This file contains the code comments for the gui_cellcount component 
